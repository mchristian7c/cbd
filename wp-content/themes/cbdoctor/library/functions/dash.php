...
function custom_dashboard_widget() {
  echo "<div class='dashwrap' style='text-align:center;background-color:#004258;margin-top:-11px;width:calc(100% + 24px);margin-left:-12px;padding-bottom:12px;margin-bottom:-12px;'>";
  echo "<p style='color:white;font-size:18px;font-weight:bold;text-align:center;padding:48px 0 18px 0;margin:0;'>Designed and built by</p>";
  	echo "<img style='display:inline-block;vertical-align:middle;' src='https://www.plottcreative.co.uk/wp-content/themes/plott-creative/images/dash-logo.png' height='78px' width='177px'>";
